...
# Mapping backends that cannot run on CPU. Both gate their Start button on this,
# so it lives here rather than as a tuple literal in each: the advanced form and
