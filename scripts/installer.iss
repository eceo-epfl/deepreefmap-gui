...
;   iscc /DBinaryPath=dist\deepreefmap-gui-windows-x64-1.2.0.exe ^
;        /DAppVersion=1.2.0 /DOutputName=deepreefmap-gui-setup-windows-x64-1.2.0 ^
...
#endif
#ifndef OutputName
  #define OutputName "deepreefmap-gui-setup-windows-x64"
#endif
...
AppPublisherURL=https://github.com/eceo-epfl/deepreefmap-gui
...
[Files]
Source: "{#BinaryPath}"; DestDir: "{app}"; DestName: "deepreefmap-gui.exe"; Flags: ignoreversion
Source: "dist\icon.ico"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{userprograms}\DeepReefMap"; Filename: "{app}\deepreefmap-gui.exe"; IconFilename: "{app}\icon.ico"
